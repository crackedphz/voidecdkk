...
module.exports = class TickleCommand extends Command {
    constructor (client) {
        super(client, {
            ...
            aliases: ["cocegas"],
            category: "fun",
            description: "Usa-se para fazer cocegas em uma pessoa.",
            CommandChannel: true
        })
    }
    ...
    async run(message, args) {
        ...
        const modouso = new Discord.MessageEmbed() 
            ...
            .setDescription(`**┏━━━━━━━━━━━━━━━━━┓**\n\n  **Comando utilizado de forma errada!**\n\n  **Forma de uso:** \`\`${ras.prefix}tickle [Usuário]\`\`\n  **Sinônimos:** \`\`${ras.prefix}cocegas [Usuário]\`\`\n\n**┗━━━━━━━━━━━━━━━━━┛**`)
		...
		const embed = new Discord.MessageEmbed()
            .setFooter(`Comando utilizado pelo usuário ${message.author.tag} | Hoje às ${horario}`, message.author.avatarURL({ dynamic:true }))
            .setColor('#FF0000')
			.setDescription(`:ok_hand: ${message.author} fez cocegas em ${member}!`)
			.setImage(img.url)
