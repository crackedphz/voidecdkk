...
module.exports = class HugCommand extends Command {
    constructor (client) {
        super(client, {
            ...
            aliases: ["abraçar"],
            category: "fun",
            description: "Usa-se para abraçar uma pessoa.",
            CommandChannel: true
        })
    }
    ...
    async run(message, args) {
        ...
        const modouso = new Discord.MessageEmbed() 
            ...
            .setDescription(`**┏━━━━━━━━━━━━━━━━━┓**\n\n  **Comando utilizado de forma errada!**\n\n  **Forma de uso:** \`\`${ras.prefix}hug [Usuário]\`\`\n  **Sinônimos:** \`\`${ras.prefix}abraçar [Usuário]\`\`\n\n**┗━━━━━━━━━━━━━━━━━┛**`)
		...
		const embed = new Discord.MessageEmbed()
            .setFooter(`Comando utilizado pelo usuário ${message.author.tag} | Hoje às ${horario}`, message.author.avatarURL({ dynamic:true }))
            .setColor('#FF0000')
			.setDescription(`:hugging: ${message.author} abraçou ${member}!`)
			.setImage(img.url)
