...
module.exports = class PatCommand extends Command {
    constructor (client) {
        super(client, {
            ...
            aliases: ["carinho"],
            category: "fun",
            description: "Usa-se para carinhar uma pessoa.",
            CommandChannel: true
        })
    }
    ...
    async run(message, args) {
        ...
        const modouso = new Discord.MessageEmbed() 
            ...
            .setDescription(`**┏━━━━━━━━━━━━━━━━━┓**\n\n  **Comando utilizado de forma errada!**\n\n  **Forma de uso:** \`\`${ras.prefix}pat [Usuário]\`\`\n  **Sinônimos:** \`\`${ras.prefix}carinho [Usuário]\`\`\n\n**┗━━━━━━━━━━━━━━━━━┛**`)
		...
		const embed = new Discord.MessageEmbed()
            .setFooter(`Comando utilizado pelo usuário ${message.author.tag} | Hoje às ${horario}`, message.author.avatarURL({ dynamic:true }))
            .setColor('#FF0000')
			.setDescription(`:man_gesturing_ok: ${message.author} fez carinho em ${member}!`)
			.setImage(img.url)
