...
module.exports = class FeedCommand extends Command {
    constructor (client) {
        super(client, {
            ...
            aliases: ["darcomida"],
            category: "fun",
            description: "Usa-se para dar comida a uma pessoa.",
            CommandChannel: true
        })
    }
    ...
    async run(message, args) {
        ...
        const modouso = new Discord.MessageEmbed() 
            ...
            .setDescription(`**┏━━━━━━━━━━━━━━━━━┓**\n\n  **Comando utilizado de forma errada!**\n\n  **Forma de uso:** \`\`${ras.prefix}feed [Usuário]\`\`\n  **Sinônimos:** \`\`${ras.prefix}darcomida [Usuário]\`\`\n\n**┗━━━━━━━━━━━━━━━━━┛**`)
		...
		const embed = new Discord.MessageEmbed()
            .setFooter(`Comando utilizado pelo usuário ${message.author.tag} | Hoje às ${horario}`, message.author.avatarURL({ dynamic:true }))
            .setColor('#FF0000')
			.setDescription(`:meat_on_bone: ${message.author} deu comida para ${member}!`)
			.setImage(img.url)
