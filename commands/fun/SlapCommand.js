...
module.exports = class SlapCommand extends Command {
    constructor (client) {
        super(client, {
            ...
            aliases: ["tapa"],
            category: "fun",
            description: "Usa-se para dar um tapa em uma pessoa.",
            CommandChannel: true
        })
    }
    ...
    async run(message, args) {
        ...
        const modouso = new Discord.MessageEmbed() 
            ...
            .setDescription(`**┏━━━━━━━━━━━━━━━━━┓**\n\n  **Comando utilizado de forma errada!**\n\n  **Forma de uso:** \`\`${ras.prefix}slap [Usuário]\`\`\n  **Sinônimos:** \`\`${ras.prefix}tapa [Usuário]\`\`\n\n**┗━━━━━━━━━━━━━━━━━┛**`)
		...
		const embed = new Discord.MessageEmbed()
            .setFooter(`Comando utilizado pelo usuário ${message.author.tag} | Hoje às ${horario}`, message.author.avatarURL({ dynamic:true }))
            .setColor('#FF0000')
			.setDescription(`:raised_back_of_hand: ${message.author} deu um tapa em ${member}!`)
			.setImage(img.url)
