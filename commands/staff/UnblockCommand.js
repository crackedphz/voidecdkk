...
module.exports = class PrefixCommand extends Command {
    constructor (client) {
        super(client, {
            name: "unblockcommands",
            aliases: ["dbcomandos"],
            category: "staff",
            description: "Comando para desbloquear comandos em um certo canal",
            CommandChannel: true,
    ...
    async run(message, args) {
        ...
        const modouso = new Discord.MessageEmbed() 
            ...
            .setDescription(`**┏━━━━━━━━━━━━━━━━━┓**\n\n  **Comando utilizado de forma errada!**\n\n  **Forma de uso:** \`\`${ras.prefix}unblockcommands [ID do canal]\`\`\n  **Sinônimos:** \`\`${ras.prefix}dbcomandos [ID do canal]\`\`\n\n**┗━━━━━━━━━━━━━━━━━┛**`)
        ...
        if (!channel) return message.channel.send(modouso)
            ...
            const resBoolean = await db.Guilds.findOneAndUpdate({_id: message.guild.id}, {$set: {commandinchannel: "false"}}, {new: true})
            message.channel.send(`Certo, os comandos foram desbloqueados nesse chat!`)
